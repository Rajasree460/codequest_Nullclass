    ...
    <Formik
      ...
      validationSchema={Yup.object({
        title: Yup.string()
          ...
          .max(150, 'Title cannot be longer than 200 characters.')
          .min(15, 'Title must be at least 20 characters.'),
        text: Yup.string()
          .required('Body is missing.')
          .min(30, 'Body must be at least 35 characters.')
          .max(30000, 'Body cannot be longer than 300000 characters.'),
        tags: Yup.array()
          .required('Please enter at least one tag.')
          .max(5, 'Please enter no more than 8 tags.')
          .of(Yup.string().max(15, 'Tag cannot be longer than 30 characters. '))
      })}
    >
      {({
        values,
        ...
        <form onSubmit={handleSubmit}>
          <div className={styles.container}>
            <FormInput
              label="Title"
              inputInfo="Be specific and imagine you are asking a question to another person"
              type="text"
              name="title"
              autoComplete="off"
              value={values.title}
            ...
            <TagInput
              label="Tags"
              inputInfo="Add up to 8 tags to describe what your question is about"
              type="text"
              name="tags"
              value={values.tags}
